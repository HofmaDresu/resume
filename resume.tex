...
\subsection{Proficient With:}
\cvline{}{.NET Stack, Xamarin Studio, Android, iOS, (ASP.NET MVC, Web API, Entity Framework), \mbox{MVVMCross}, \mbox{SQL Server}, NancyFX, DurandalJS, \mbox{KnockoutJS}, jQuery, BreezeJS, Visual Studio (2005 - 2015), \mbox{SQL Server Management Studio}, Vim, Git}
\subsection{Experience With:}
\cvline{}{Power Pivot, Eclipse, Chrome Developer Tools, Bootstrap, Subversion, JetBrain's DotTrace, Redis, Azure, RabbitMQ, Quartz.NET, Telerik's JustTrace}
