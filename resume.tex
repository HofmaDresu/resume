...
\cvline{}{Clojure, Scala, Objective C, Erlang, Elixir, Haskell}
\section{Technologies and Tools}
\subsection{Certifications:}
\cvline{}{Xamarin Certified Mobile Developer (2016, 2017, 2018)}
\subsection{Proficient With:}
\cvline{}{Visual Studio Code, Xamarin Studio, Android, iOS, Entity Framework, ReactJS, \mbox{Redux}, Jest, Webpack, \mbox{Xamarin Forms}, \mbox{MVVMCross}, \mbox{SQL Server}, NancyFX, Visual Studio, \mbox{SQL Server Management Studio}, Vim, Git}
\subsection{Experience With:}
\cvline{}{npm, RethinkDb, Visual Studio App Center, Node.js, HockeyApp, ASP.NET MVC, Web API, WPF, Chrome Developer Tools,  Subversion, JetBrain's DotTrace, Redis, Azure, RabbitMQ, Quartz.NET, Telerik's JustTrace, DurandalJS, \mbox{KnockoutJS}, jQuery, lodash}

\section{Experience}
\cventry{2016--Present}{Multi-system Developer}{Seamgen}{}{}{}   
    \begin{itemize}[leftmargin=1.24in]
    	\item Onsite Printing Application for Comic-Con International (WPF and Node.js Developer)
    		\begin{itemize}
    			...
    			\item Improved performance of long-running endpoint by 50\%
    			\item Refactored existing code to allow for greater re-use and reduce bug rate
    			\item Helped other developers improve their knowledge of the latest C\# features
    			\item Broke out stories into subtasks for better sprint planning
   			\end{itemize}
