...
\subsection{Proficient With:}
\cvline{}{Visual Studio Code, Xamarin Studio, Android, iOS, Entity Framework, \mbox{ReactJS}, \mbox{Redux}, Jest, webpack, \mbox{Xamarin Forms}, \mbox{MVVMCross}, \mbox{SQL Server}, Visual Studio, \mbox{SQL Server Management Studio}, Vim, Git, Prism for WPF, Sequel Pro}
\subsection{Experience With:}
\cvline{}{npm, RethinkDb, Visual Studio App Center, Node.js, HockeyApp, React Native, Sequelizer, DynamoDB, ASP.NET MVC, Web API, WPF, Chrome Developer Tools, Redis, Azure, jQuery, lodash, Prism for Xamarin Forms}
