...
\cvline{}{SASS, Clojure, Java, Scala, VB.NET}
\section{Technologies and Tools}
\subsection{Certifications:}
\cvline{}{Xamarin Mobile Developer}
\subsection{Proficient With:}
\cvline{}{.NET Stack (ASP.NET MVC, Web API, Entity Framework), Xamarin, Android, iOS, SQL Server, NancyFX, DurandalJS, \mbox{KnockoutJS}, jQuery, BreezeJS, RabbitMQ, Quartz.NET, Visual Studio, \mbox{SQL Server Management Studio}, Vim, Git, Telerik's JustTrace}
\subsection{Experience With:}
...
\cventry{2014--Present}{Co-Founder}{\href{http://fudi.st}{Fudist, LLC}}{}{}{}
    \begin{itemize}[leftmargin=1.24in]
    	...
    	\item Envisioned and developed \href{https://github.com/HofmaDresu/MakeMeMove}{Make Me Move} application (currently in pre-alpha)
    \end{itemize}
\cventry{2015--Present}{Tech Lead / Developer}{Seamgen}{}{}{}   
	\begin{itemize}[leftmargin=1.24in]
		\item Took over Tech Lead position on legacy replacement project
		\item Managed Code Reviews, Deployments and Version control
		\item Developed key features for 2 legacy replacement projects
		\item Created detailed plan to combine 2 websites into a single, unified system
