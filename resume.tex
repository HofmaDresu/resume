...
\cvline{}{Java, Objective C, VB.NET, LESS}
...
\subsection{Proficient With:}
\cvline{}{Xamarin Studio, Android, iOS, Entity Framework, ReactJS, Redux, Jest, Webpack, \mbox{Xamarin Forms}, \mbox{MVVMCross}, \mbox{SQL Server}, NancyFX, Visual Studio, \mbox{SQL Server Management Studio}, Vim, Git}
\subsection{Experience With:}
\cvline{}{HockeyApp, ASP.NET MVC, Web API, WPF, Power Pivot, Eclipse, Chrome Developer Tools, Bootstrap, Subversion, JetBrain's DotTrace, Redis, Azure, RabbitMQ, Quartz.NET, Telerik's JustTrace, DurandalJS, \mbox{KnockoutJS}, jQuery, BreezeJS}
